...
- Analyzing categorical Data ([website](https://sarahkaspar.github.io/categorical-data/08-modeling.html) / [github](https://github.com/sarahkaspar/categorical-data))
- [Interactive tutorial on Linear Models](https://shiny-portal.embl.de/shinyapps/app/22_deploymentlinearmodels)

# Teaching events

- 2025-06: [Data Science for Life Scientists](https://www.ebi.ac.uk/training/events/data-science-for-life-scientists/)
- 2024-12: [Hands-on course for sample preparation and data analysis in proteomics](https://www.embl.org/about/info/course-and-conference-office/events/sdp24-01/)
